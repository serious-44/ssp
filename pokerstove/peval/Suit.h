...
public:
    ...
    enum display { SUIT_ASCII = 1,              //!< plain old ascii chars
    ...
    /**
     * Construct suit from the first char of the input string.  Exception will be thrown
     * if the character is not a valid suit character.
     *
